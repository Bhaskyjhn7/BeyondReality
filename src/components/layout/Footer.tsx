...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "https://github.com/Bhaskyjhn7", label: "GitHub" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
              We build intelligent software solutions that help businesses
              operate smarter, move faster, and grow beyond their current
              limitations.
            </p>
            <div className="flex gap-4">
              <a
                href="https://linkedin.com"
                className="w-9 h-9 bg-slate-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://github.com/Bhaskyjhn7"
                className="w-9 h-9 bg-slate-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors"
                aria-label="GitHub"
              >
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">
            &copy; {new Date().getFullYear()} Beyond Reality. All rights reserved.
          </p>
